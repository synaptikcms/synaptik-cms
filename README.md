...
[Live Demo](https://synaptikcms.com/synaptik-demo/) · [Documentation](https://synaptikcms.com/docs/) · [Changelog](CHANGELOG.md) · [Report a Bug](https://github.com/synaptikcms/synaptik-cms/issues)
...
- **CSS Editor** — live-edit your theme stylesheet with automatic backup before each save
...
- Add a new language by dropping a JSON file in `/lang/`
