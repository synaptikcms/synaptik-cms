...
- **Built-in Powerful Search Engine** — `Ctrl+K` (or `CMD+K`) overlay, no external dependency
...
- **Backup and Restore** — save your database, restore your website content in 1 click
...
- **Updates Notitications** — get notified about updates directly in the dashboard
