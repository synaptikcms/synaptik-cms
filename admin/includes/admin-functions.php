...
function admin_save_credentials(array $fields): bool {
	...
	// var_export() produces a syntactically valid PHP literal for any string,
	// including those containing backslashes or single quotes.
	$content  = "<?php\n";
	$content .= "// Admin credentials — do not edit this file manually\n";
	$content .= "\$admin_username     = " . var_export($admin_username,     true) . ";\n";
	$content .= "\$admin_display_name = " . var_export($admin_display_name, true) . ";\n";
	$content .= "\$admin_password     = " . var_export($admin_password,     true) . ";\n";
	if ($admin_email !== '') {
		$content .= "\$admin_email        = " . var_export($admin_email, true) . ";\n";
	}
	$content .= "?>\n";
