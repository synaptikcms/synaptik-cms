		   ...
		   <div class="menu-modal-content">
			 ...
			 <div class="menu-modal-form">
			   ...
			   <div class="menu-modal-footer">
				 <button type="button" id="cancel-edit-menu" class="button cancel">${window.t('cancel')}</button>
				 <button type="button" id="save-menu-item-btn" class="button">${window.t('save_changes')}</button>
			   </div>
			 </div>
		   </div>
		 </div>
...
function addMenuItem(item) {
	...
	html += '<button type="button" class="button edit-menu-item">' + window.t('edit') + '</button>';
	html += '<button type="button" class="button remove-menu-item">' + window.t('remove') + '</button>';
	html += '</div>';
