...
// 		if (!confirm(msg)) return;
	...
	function _getInterval() {
		// Fallback: 5 minutes. window.AUTOSAVE_INTERVAL_SECONDS is injected server-side.
		return (window.AUTOSAVE_INTERVAL_SECONDS > 0 ? window.AUTOSAVE_INTERVAL_SECONDS : 300) * 1000;
	}
	...
	function startAutoSave() {
		...
		_timer = setInterval(saveDraft, _getInterval());
	}
